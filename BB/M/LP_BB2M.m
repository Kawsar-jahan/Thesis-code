fid1=fopen('checkBB10M.txt','w');
fid=fopen('input10.txt');
fid2=fopen('approxIR1LP10M.txt','w');
fid3=fopen('approxBBLP10M.txt','w');
fid4=fopen('timeLPBB10M.txt','w');
fid5=fopen('timeIPBB10M.txt','w');
fid6=fopen('timeIRBB10M.txt','w');
fid7=fopen('highestIR1LP10M.txt','w');
fid8=fopen('highestBBLP10M.txt','w');
fid9=fopen('approxIR1BB10M.txt','w');
fid10=fopen('highestIR1BB10M.txt','w');
fid11=fopen('timeBB10M.txt','w');
fid12=fopen('IPBB10M.txt','w');
fid13=fopen('numberofnodesM.txt','w');
fid14=fopen('numberofpointsM.txt','w');
fid15=fopen('approxIR1IP10M.txt','w');
fid16=fopen('highestIR1IP10M.txt','w');
