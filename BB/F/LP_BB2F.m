fid1=fopen('checkBB10F.txt','w');
fid=fopen('input10.txt');
fid2=fopen('approxIR1LP10F.txt','w');
fid3=fopen('approxBBLP10F.txt','w');
fid4=fopen('timeLPBB10F.txt','w');
fid5=fopen('timeIPBB10F.txt','w');
fid6=fopen('timeIRBB10F.txt','w');
fid7=fopen('highestIR1LP10F.txt','w');
fid8=fopen('highestBBLP10F.txt','w');
fid9=fopen('approxIR1BB10F.txt','w');
fid10=fopen('highestIR1BB10F.txt','w');
fid11=fopen('timeBB10F.txt','w');
fid12=fopen('IPBB10F.txt','w');
fid13=fopen('numberofnodesF.txt','w');
fid14=fopen('numberofpointsF.txt','w');
fid15=fopen('approxIR1IP10F.txt','w');
fid16=fopen('highestIR1IP10F.txt','w');
