...
fid2=fopen('approxLPBB10L.txt','w');
fid3=fopen('approxIPBB10L.txt','w');
fid4=fopen('timeLPBB10L.txt','w');
fid5=fopen('timeIPBB10L.txt','w');
fid6=fopen('timeIRBB10L.txt','w');
fid7=fopen('highestLPBB10L.txt','w');
fid8=fopen('highestIPBB10L.txt','w');
fid9=fopen('approxBB10L.txt','w');
fid10=fopen('highestBB10L.txt','w');
